...
const WheelDetails = () => {
    ...
    const getRandomTires = (wheel, count) => {
        let shuffled = wheel.sort(() => 0.5 - Math.random());
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            if (wheel) {
                const foundTire = wheel.find(wheel => wheel.id === intId);
                if (foundTire) {
                    setNewTire(foundTire);
                    setTotal(foundTire.price * 100); 
                    setRandomTires(getRandomTires(wheel, 6));
                } else {
                    ...
                    <div className="overflow-x-auto ">
                        <table className="table border-2 border-zinc-300 bg-[#040404c1] text-white">
                            <tbody className="">
                                <tr>
                                    <td>Purpose:</td>
                                    <td>{newTire.Purpose}</td>
                                </tr>
                                <tr>
                                    <td>Material:</td>
                                    <td>{newTire.Material}</td>
                                </tr>
                                <tr>
